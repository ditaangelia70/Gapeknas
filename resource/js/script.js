document.getElementById('visiButton').addEventListener('click', function() {
    document.getElementById('content').innerHTML = 
    '<p>Menjadi Lembaga Sertifikasi Badan Usaha terdepan dalam meningkatkan kualitas usaha badan usaha jasa konstruksi yang lebih mandiri dan mempunyai daya saing tinggi</p>';
});

document.getElementById('misiButton').addEventListener('click', function() {
    document.getElementById('content').innerHTML = 
